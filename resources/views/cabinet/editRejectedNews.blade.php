...
@section('content')
    <h6>Редагувати відхилену новину:</h6>
    <form method="post" action="{{ route('cabinet.updateRejectedNews', $news) }}" enctype='multipart/form-data' style="width: 300px;">
        @csrf
        @method('PUT')
        ...
        <button type="submit" class='btn btn-primary mb-3'>Відправити на перевірку</button>
    </form>
@endsection
